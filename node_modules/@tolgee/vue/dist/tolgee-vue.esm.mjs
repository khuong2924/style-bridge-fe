import { defineComponent, inject, computed, onMounted, ref, onBeforeMount, onUnmounted, getCurrentInstance, watch } from 'vue';
import { getFallback, getTranslateProps } from '@tolgee/web';
export * from '@tolgee/web';

/* eslint-disable @typescript-eslint/no-var-requires */
const TolgeeProvider = defineComponent({
    name: 'TolgeeProvider',
    props: {
...
export { GlobalContextPlugin, T, TolgeeProvider, VueTolgee, useTolgee, useTranslate };
//# sourceMappingURL=tolgee-vue.esm.mjs.map
